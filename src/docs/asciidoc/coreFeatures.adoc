...
Like the imperative example above, the following example ensures that when we
fallback to the cache, we at least log that the external service had a failure.
